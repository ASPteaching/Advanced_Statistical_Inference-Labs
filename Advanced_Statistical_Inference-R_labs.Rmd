...
in time. Assuming the standard deviation is 3, and has been estimated:
...
We cab write a function implementing this likelihoos or use the one
available in R.
...
Unit 3B (slides 78-80) to run Expectation Maximization on a mixture of two normal distributions.
